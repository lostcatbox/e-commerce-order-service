...
class DistributedLockManager(
    ...
    override fun <T> executeWithLock(
        ...
        try {
            ...
            val newTransactionTemplate = getNewTransactionTemplate()

            // 락 획득 후 수동으로 트랜잭션 실행
            return newTransactionTemplate.execute {
                business()
    ...
    override fun executeWithLockVoid(
        ...
        try {
            ...
            val newTransactionTemplate =
                getNewTransactionTemplate()

            newTransactionTemplate.executeWithoutResult { _ ->
                business()
            }
        } catch (e: InterruptedException) {
            Thread.currentThread().interrupt()
    ...
    private fun getNewTransactionTemplate(): TransactionTemplate = transactionTemplate
}
