...
import kr.hhplus.be.server.controller.coupon.dto.UserCouponResponse
...
class CouponController(
    ...
    fun getUserCoupon(
        ...
        val userCoupon = couponService.getUserCoupon(userCouponId)
    ...
    fun useCoupon(
        ...
        val usedUserCoupon = couponService.useCoupon(userCouponId)
        return UserCouponResponse.from(usedUserCoupon)
    }
}
