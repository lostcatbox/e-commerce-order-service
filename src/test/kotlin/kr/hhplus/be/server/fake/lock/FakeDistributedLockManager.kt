...
class FakeDistributedLockManager : DistributedLockManagerInterface {
    ...
    override fun getUserPointLockKey(userId: Long): String = "test-lock:user-point:$userId"

    override fun getCouponIssueLockKey(couponId: Long): String = "test-lock:coupon-issue:$couponId"

    override fun getProductStockLockKey(productId: Long): String = "test-lock:product-stock:$productId"
}
